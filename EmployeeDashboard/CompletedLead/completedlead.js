...
const dummyData = [
  {
    ...
    bankerName: "David Clark", // Add "bankerName"
  },
  {
    id: "060624DCS",
    date: "07.06.2023",
    ...
    bankerName: "John Doe", // Add "bankerName"
  },
...
function populateProductRows() {
  ...
  dummyData.forEach(function (data) {
    ...
    newRow.innerHTML = `
      ...
      <div class="product-cell category"><span class="cell-label">Name:</span>${data.name}</div>
      ...
      <div class="product-cell price"><span class="cell-label">Banker Name:</span>${data.bankerName}</div>
    `;
